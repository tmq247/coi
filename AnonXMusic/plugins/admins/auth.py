...
@app.on_message(filters.command("capquyen") & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(filters.command("xoaquyen") & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(
    filters.command(["listquyen", "danhsachquyen"]) & filters.group & ~BANNED_USERS
)
@language
